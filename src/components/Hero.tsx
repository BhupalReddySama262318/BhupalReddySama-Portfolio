  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="fade-in flex flex-col md:flex-row items-center justify-center gap-10 md:gap-16">
          <img 
            src="/image.png" 
            alt="Bhupal Reddy Sama profile" 
            className="rounded-full shadow-lg border-4 border-white dark:border-zinc-800 flex-shrink-0" 
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p ref={paraRef} className="text-lg md:text-xl text-muted-foreground mb-12 max-w-3xl mx-auto md:mx-0 leading-relaxed">
